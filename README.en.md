...
The primary README for this repository is now the Chinese version at `README.md`.
...
| Version | Changes |
| --- | --- |
| v1.1.0 | Added Memory Module V1 documentation in the primary Chinese README, introduced the archive note for the current memory system build, and promoted the Chinese README to the main repository README. |
